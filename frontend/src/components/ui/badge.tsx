  ...
  "inline-flex items-center rounded-md border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300",
  {
    variants: {
      variant: {
        ...
        brand:
          "border-transparent bg-emerald-600 text-white shadow hover:bg-emerald-700 dark:bg-emerald-500 dark:text-emerald-950 dark:hover:bg-emerald-500/90",
        brandOutline:
          "text-emerald-700 border border-emerald-600 dark:text-emerald-300 dark:border-emerald-400",
      },
    },
    defaultVariants: {
      variant: "default",
